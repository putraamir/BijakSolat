...
const submitCsv = () => {
    ...
    formData.append('csv_file', csvForm.csv_file);
    ...
    router.post(route('evaluation.import'), formData, {
        ...
        onError: (errors) => {
            alert(errors.error || 'Failed to import CSV');
        }
    });
};
...
const clearYear = () => {
    if (confirm('Adakah anda pasti untuk memadamkan semua kategori untuk tahun ini?')) {
        router.delete(route('evaluation.clear', selectedYear.value), {
            onSuccess: () => {
                window.location.reload();
            }
        });
...
<template>
    <div class="p-4 md:p-6">
        ...
        <div v-if="showAddModal"
            ...
            <div class="bg-white rounded-lg p-4 md:p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                ...
                <form @submit.prevent="submitForm" class="space-y-4">
                    ...
                    <div class="space-y-4">
                        <div class="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-4">
                            <label class="inline-flex items-center mr-4">
                                <input type="radio" v-model="isNewCategory" :value="true" class="form-radio mr-2">
                                <span>New Category</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" v-model="isNewCategory" :value="false" class="form-radio mr-2">
                    ...
                    <button type="button" @click="addItem" class="text-mint-600 mt-2">
                        + Add Item
                    </button>
        ...
        <div v-if="showCsvModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                ...
                <form @submit.prevent="submitCsv" class="space-y-4">
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-gray-500">
                            Format: title,type,sequence,category
                        </p>
                    </div>
